    ...
    function Value(value) {
        ...
        this.should_be = function (expectValue) {
            if (type != Object.prototype.toString.call(expectValue) || !EQUALS(value, expectValue)) {
                throw {failure: 1, 
                    expect: (expectValue === null || expectValue === undefined) ? String(expectValue) : expectValue, 
                    actual: (value === null || value === undefined) ? String(value) : value};
            }
        };
