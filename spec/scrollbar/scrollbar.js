...
describe('垂直滚动条(VScrollbar)',{
    ...
    '基本属性与部件属性': function () {
        ...
        value_of(scrollbar.getTypes()).should_be(['ui-vscrollbar', 'ui-scrollbar']);
